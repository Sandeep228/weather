...
const getrise = async() => {
  try {
    ...
    if (response) {
      ...
      console.log(set)
      setsun(set)
    //   const sunrise = new Date(set.sunrise);
    // const sunset = new Date(set.sunset);
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(
      ...
      () => {
        toast.error('GeoLocation request denied. Please reset location permission to grant access again.');
      }
    );
  }, []);
